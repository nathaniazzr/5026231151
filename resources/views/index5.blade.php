...
<table class="custom-table">
    ...
    <tbody>
        @foreach($karyawan as $q)
        <tr>
            <td style="padding: 12px 15px; text-align: center;">{{ $q->kodepegawai }}</td>
            <td style="padding: 12px 15px; text-align: center;">{{ $q->namalengkap }}</td>
            <td style="padding: 12px 15px; text-align: center;">{{ $q->divisi }}</td>
            <td style="padding: 12px 15px; text-align: center;">{{ $q->departemen }}</td>
            <td style="padding: 12px 15px; text-align: center;">
                <a href="/karyawan/hapus/{{ $q->kodepegawai }}" class="btn btn-danger btn-sm" style="padding: 8px 15px; border-radius: 25px; background-color: #aa74c5; color: white; border: none;">Hapus</a>
            </td>
        </tr>
        @endforeach
    </tbody>
...
<a href="/karyawan/tambah" class="btn btn-primary mb-3" style="border-radius: 25px; padding: 10px 20px; font-weight: bold;">+ Tambah Data</a>
